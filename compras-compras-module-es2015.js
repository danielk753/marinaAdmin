...
/* harmony import */ var src_app_own_dialog_dialog_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/own/dialog/dialog.component */ "./src/app/own/dialog/dialog.component.ts");
/* harmony import */ var ng2_completer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ng2-completer */ "./node_modules/ng2-completer/esm2015/ng2-completer.js");
...
let ComprasComponent = class ComprasComponent {
    constructor(ticketsService, dialogService, completerService) {
        ...
        this.tableStructure = {
            columns: [
                ...
                { title: 'Aplicado', name: 'aplicado', editable: true, type: 'toggle', filter: false },
                // {title: 'Productos', name: 'productos', editable: false, type: 'button', filter: false},
                { title: 'Proveedor', name: 'agente_id', editable: true, type: 'list', filter: true },
                { title: 'No. factura', name: 'numero_factura', editable: true, type: 'number', filter: true },
                { title: 'Solicitud', name: 'fecha_solicitud', editable: true, type: 'date', filter: true },
                { title: 'Enterega', name: 'fecha_entrega', editable: true, type: 'date', filter: true },
                { title: 'Subtotal', name: 'subtotal', editable: true, type: 'number', filter: true },
                { title: 'Iva', name: 'iva', editable: true, type: 'number', filter: true },
                { title: 'Total', name: 'total', editable: true, type: 'number', filter: true },
            ],
            buttons: {
                create: false,
                delete: true,
    ...
    delete(deleteData, dataTable) {
        this.dialogService.open(src_app_own_dialog_dialog_component__WEBPACK_IMPORTED_MODULE_4__["DialogComponent"], {
            context: {
                title: '¡Cuidado!',
                content: `Si elimina este registro, se perderá el historial de movimientos relacionados. ¿Desea continuar?`
            },
    ...
    clickAgregarProducto() {
        this.compra.productos.push({ cantidad: 1 });
    }
...
ComprasComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./compras.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/compras/compras.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./compras.component.scss */ "./src/app/pages/compras/compras.component.scss")).default]
    })
], ComprasComponent);
...
/* harmony import */ var _compras_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./compras.component */ "./src/app/pages/compras/compras.component.ts");
...
/* harmony import */ var src_app_own_data_table_data_table_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/own/data-table/data-table.module */ "./src/app/own/data-table/data-table.module.ts");
...
const routes = [
    { path: '', component: _compras_component__WEBPACK_IMPORTED_MODULE_3__["ComprasComponent"] }
];
let ComprasModule = class ComprasModule {
};
ComprasModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [_compras_component__WEBPACK_IMPORTED_MODULE_3__["ComprasComponent"]],
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forChild(routes),
            src_app_own_data_table_data_table_module__WEBPACK_IMPORTED_MODULE_6__["DataTableModule"],
            // Nebular Modules
