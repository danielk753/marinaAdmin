...
const routes = [
    {
        path: '', component: _pages_component__WEBPACK_IMPORTED_MODULE_3__["PagesComponent"], children: [
            ...
            { path: 'productos', loadChildren: () => Promise.all(/*! import() | productos-productos-module */[__webpack_require__.e("default~agentes-agentes-module~clientes-clientes-module~compras-compras-module~productos-productos-module"), __webpack_require__.e("productos-productos-module")]).then(__webpack_require__.bind(null, /*! ./productos/productos.module */ "./src/app/pages/productos/productos.module.ts")).then(m => m.ProductosModule) },
            { path: 'agentes', loadChildren: () => Promise.all(/*! import() | agentes-agentes-module */[__webpack_require__.e("default~agentes-agentes-module~clientes-clientes-module~compras-compras-module~productos-productos-module"), __webpack_require__.e("agentes-agentes-module")]).then(__webpack_require__.bind(null, /*! ./agentes/agentes.module */ "./src/app/pages/agentes/agentes.module.ts")).then(m => m.AgentesModule) },
            { path: 'clientes', loadChildren: () => Promise.all(/*! import() | clientes-clientes-module */[__webpack_require__.e("default~agentes-agentes-module~clientes-clientes-module~compras-compras-module~productos-productos-module"), __webpack_require__.e("clientes-clientes-module")]).then(__webpack_require__.bind(null, /*! ./clientes/clientes.module */ "./src/app/pages/clientes/clientes.module.ts")).then(m => m.ClientesModule) },
            { path: 'compras', loadChildren: () => Promise.all(/*! import() | compras-compras-module */[__webpack_require__.e("default~agentes-agentes-module~clientes-clientes-module~compras-compras-module~productos-productos-module"), __webpack_require__.e("compras-compras-module")]).then(__webpack_require__.bind(null, /*! ./compras/compras.module */ "./src/app/pages/compras/compras.module.ts")).then(m => m.ComprasModule) },
...
PagesModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            _nebular_theme__WEBPACK_IMPORTED_MODULE_5__["NbBidiModule"],
